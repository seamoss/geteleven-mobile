...
export const FEATURE_FLAGS = {
  ...
  DEBUG_PAYMENT_FLOWS: true, // Enable to see detailed payment debugging
  DEBUG_REVENUECAT: true, // Enable to see RevenueCat debugging
  ...
  REVENUECAT_API_KEY_IOS: 'appl_wQQiABdCHZdpqZalULxVrDZGaSk',
