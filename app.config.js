  ...
  "expo": {
    ...
    "ios": {
      ...
      "infoPlist": {
        ...
        "NSCameraUsageDescription": "This app uses the camera to let you take a profile photo.",
        "NSPhotoLibraryUsageDescription": "This app accesses the photo library to let you select a profile photo.",
        "NSMicrophoneUsageDescription": "This app uses the microphone to record and send voice messages to your connections.",
        "UIBackgroundModes": [
          "audio",
          "audio",
          "background-fetch",
